...
1. **MNIST**: Requires `../nucleus_data/mnist.npz` (with `x_train` and `y_train`).
...
- **Environment Variables**: Use `VIZ_DATA_DIR` to specify a custom location for the `nucleus_data` folder.
