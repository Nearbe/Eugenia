...
class DualNumber:
    ...
    def apply(self, fn: Callable[[object], object], derivative: Callable[[object], object]) -> DualNumber:
        """Return ``f(x) + f'(x)·v·ε``."""
        from .u_algebra import multiply
